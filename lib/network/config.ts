...
export const ethereumConfig: NetworkConfig = {
  ...
  chainId: 1,
  rpcUrl:
    'https://eth-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const unichainConfig: NetworkConfig = {
  ...
  chainId: 130,
  rpcUrl: 'https://unichain-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const bnbSmartChainConfig: NetworkConfig = {
  ...
  displayName: 'BSC',
  chainId: 56,
  rpcUrl: 'https://bnb-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const sonicConfig: NetworkConfig = {
  ...
  displayName: 'Sonic',
  chainId: 146,
  rpcUrl: 'https://sonic-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const berachainConfig: NetworkConfig = {
  ...
  chainId: 80094,
  rpcUrl:
    'https://berachain-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const baseConfig: NetworkConfig = {
  ...
  chainId: 8453,
  rpcUrl:
    'https://base-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const arbitrumConfig: NetworkConfig = {
  ...
  chainId: 42161,
  rpcUrl:
    'https://arb-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const polygonConfig: NetworkConfig = {
  ...
  chainId: 137,
  rpcUrl:
    'https://polygon-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const optimismConfig: NetworkConfig = {
  ...
  chainId: 10,
  rpcUrl:
    'https://opt-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
...
export const mantleConfig: NetworkConfig = {
  ...
  displayName: 'Mantle',
  chainId: 5000,
  rpcUrl: 'https://mantle-mainnet.g.alchemy.com/v2/49uzw3w2TI0X9Rad5aRI5',
