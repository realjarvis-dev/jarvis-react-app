...
export function researcher({
  ...
  try {
    ...
    const all_tools = ['search', 'retrieve', 'videoSearch', 'ask_question', 'pendle_opportunities', 'pendle_quote', 'pendle_swap', 'kodiak_opportunities', 'wallet_balance', 'privy_transfer']
